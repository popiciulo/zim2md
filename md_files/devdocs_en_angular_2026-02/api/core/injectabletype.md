...
A [`Type`](type) which has a `ɵprov: ɵɵInjectableDeclaration` static field.
...
[`InjectableType`](injectabletype)s contain their own Dependency Injection metadata and are usable in an `InjectorDef`-based `StaticInjector`.

Super-powered by Google ©2010–2025.  
Code licensed under an MIT-style License. Documentation licensed under CC BY 4.0.  
<https://angular.dev/api/core/InjectableType>
