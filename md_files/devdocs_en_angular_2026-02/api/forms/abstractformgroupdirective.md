...
A base class for code shared between the [`NgModelGroup`](ngmodelgroup) and [`FormGroupName`](formgroupname) directives.
...
<https://angular.dev/api/forms/AbstractFormGroupDirective>
