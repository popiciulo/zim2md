...
A directive which installs the [`MinValidator`](minvalidator) for any `formControlName`, `formControl`, or control with `ngModel` that also has a `min` attribute.
...
<https://angular.dev/api/forms/MinValidator>
