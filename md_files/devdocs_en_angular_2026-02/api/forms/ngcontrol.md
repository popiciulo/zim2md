...
A base class that all [`FormControl`](formcontrol)-based directives extend. It binds a [`FormControl`](formcontrol) object to a DOM element.
...
abstract class NgControl extends AbstractControlDirective {
  ...
  override readonly path: string[] | null;
...
<https://angular.dev/api/forms/NgControl>
