...
**TIP:** Check out Angular's [Essentials](https://angular.dev/essentials/dependency-injection) before diving into this comprehensive guide.
...
Angular uses the term "injection context" to describe any place in your code where you can call [`inject`](../api/core/inject). While component, directive, and service construction is the most common, see [injection contexts](di/dependency-injection-context) for more details.
...
The next guide, [Creating and using services](di/creating-and-using-services), will show you:
