...
You can create a service with the [Angular CLI](https://angular.dev/tools/cli) with the following command:
...
You can also manually create a service by adding the [`@Injectable()`](../../api/core/injectable) decorator to a TypeScript class. This tells Angular that the service can be injected as a dependency.
...
You can learn more about these advanced patterns in the next guide: [defining dependency providers](defining-dependency-providers).
