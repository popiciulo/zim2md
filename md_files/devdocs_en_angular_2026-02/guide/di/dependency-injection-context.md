...
**NOTE:** For basic examples of using `inject()` in class constructors and field initializers, see the [overview guide](../di#where-can-inject-be-used).
...
Calling [`inject`](../../api/core/inject) or calling [`assertInInjectionContext`](../../api/core/assertininjectioncontext) outside of an injection context will throw [error NG0203](https://angular.dev/errors/NG0203).
