...
This section provides examples of both kinds of guards. For more information, see [Template type checking](https://angular.dev/tools/cli/template-typecheck "Template type-checking guide").
