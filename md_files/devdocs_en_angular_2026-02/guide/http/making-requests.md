...
By default, [`HttpParams`](../../api/common/http/httpparams) uses the built-in [`HttpUrlEncodingCodec`](../../api/common/http/httpurlencodingcodec) to encode and decode parameter keys and values.
