...
`router.navigate()` supports both simple and complex routing scenarios, allowing you to pass route parameters, [query parameters](read-route-state#query-parameters), and control navigation behavior.
...
Learn how to [read route state](read-route-state) to create responsive and context-aware components.
