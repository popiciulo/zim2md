...
Check out the [`ActivatedRoute`](../../api/router/activatedroute) API docs for a complete list of what you can access with in the route.
...
Check out the [`ActivatedRoute`](../../api/router/activatedroute) API docs and [`ActivatedRouteSnapshot`](../../api/router/activatedroutesnapshot) API docs for a complete list of all properties you can access.
...
You can [define route parameters](define-routes#define-url-paths-with-route-parameters) by prefixing the parameter name with a colon (`:`).
