...
📖 **Implementation:** See [Customizing build-time prerendering](../ssr#customizing-build-time-prerendering-ssg) in the SSR guide.
...
Once the client renders the page, Angular [hydrates](../hydration#what-is-hydration) the app and it then runs entirely in the browser like a traditional SPA - subsequent navigation, route changes, and API calls all happen client-side without additional server rendering.
...
📖 **Implementation:** See [Server routing](../ssr#server-routing) and [Authoring server-compatible components](../ssr#authoring-server-compatible-components) in the SSR guide.
...
- [Hydration guide](../hydration) - Complete hydration setup
- [Incremental hydration](../incremental-hydration) - Advanced hydration with `@defer` blocks

## Next steps

  [Server-Side Rendering](../ssr)   [Hydration](../hydration)   [Incremental Hydration](../incremental-hydration)  
