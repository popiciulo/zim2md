...
| `attach` | When the [`RouteReuseStrategy`](../../api/router/routereusestrategy) instructs the outlet to attach the subtree |
| `detach` | When the [`RouteReuseStrategy`](../../api/router/routereusestrategy) instructs the outlet to detach the subtree |
...
Learn how to [navigate to routes](navigate-to-routes) with Angular Router.

Super-powered by Google ©2010–2025.  
Code licensed under an MIT-style License. Documentation licensed under CC BY 4.0.  
<https://angular.dev/guide/routing/show-routes-with-outlets>
