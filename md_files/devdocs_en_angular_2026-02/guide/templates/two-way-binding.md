...
1. Import the [`FormsModule`](../../api/forms/formsmodule) from `@angular/forms`
...
The child component must contain a [`model`](../../api/core/model) property.
...
1. Wrap the [`model`](../../api/core/model) property name in the two-way binding syntax.
2. Assign a property or a signal to the [`model`](../../api/core/model) property.
