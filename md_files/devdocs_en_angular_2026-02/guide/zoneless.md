...
The zoneless provider function can also be used with [`TestBed`](../api/core/testing/testbed) to help ensure the components under test are compatible with a Zoneless Angular application.
